...
@export var mirroredForm: BlockMinamitsu = null		# Refers to the same-position block on the other side of the mirror
...
# Since the Timer automatically reactivates, this will go through the array until it reaches the end and stops the timer
